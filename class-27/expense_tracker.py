...
def load_data():
    ...
    with open("/Users/User/python-2/class-27/json/incomes.json", "r") as f:
        incomes = json.load(f)
    with open("/Users/User/python-2/class-27/json/expenses.json", "r") as f:
        expenses = json.load(f)
    with open("/Users/User/python-2/class-27/json/categories.json", "r") as f:
        categories = json.load(f)

def save_data():
    with open("/Users/User/python-2/class-27/json/incomes.json", "w") as f:
        json.dump(incomes, f)
    with open("/Users/User/python-2/class-27/json/expenses.json", "w") as f:
        json.dump(expenses, f)
    with open("/Users/User/python-2/class-27/json/categories.json", "w") as f:
